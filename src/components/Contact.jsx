      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
          <p className="pt-20 font-float mt-0 mb-4 text-4xl ">
            {" "}
            <span className="border-b-2 white">Contact </span>
          </p>

          <p className="py-2">
            Want to learn more about my experience and skills as a junior
            developer? Fill out the form below to get in touch and start the
            conversation.
          </p>
        </div>
