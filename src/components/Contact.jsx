        ...
        <div className="flex flex-col p-4 justify-center max-w-screen-lg gap-y-8 mx-auto h-full">
          ...
          <div className="flex justify-center items-center ">
            <form
              ...
              method="POST"
              className="flex flex-col w-full md:w-[400px] text-black"
            >
              <input
                type="text"
                name="name"
                placeholder="Enter Your Name"
                className="p-2 bg-transparent border-2 border-gray-600/20 rounded-md focus:outline-none"
              />
              <input
                type="text"
                name="email"
                placeholder="Enter Your Email"
                className="my-1 p-2 bg-transparent border-2 border-gray-600/20 rounded-md focus:outline-none"
              />
              <textarea
                name="message"
              ...
              px-6 py-2 mt-2 mx-auto flex items-center rounded-md border-2 border-gray-600/20 hover:scale-110 duration-300 text-black"
              >
                Submit to Talk
              </button>
            </form>
